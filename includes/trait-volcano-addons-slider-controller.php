...
trait Volcano_Addons_Slider_Controller {
	...
	protected function render_slider_controller( $options = [] ) {
		...
		$options = volcano_addons_parse_args_recursive( $options, $defaults );

		$this->start_controls_section(
			'volcano_addons_section_slider',
			[
				'label'      => __( 'Slider Options', 'volcano-addons' ),
		...
		$this->add_responsive_control(
			'slides_to_show',
			[
				'label'       => __( 'Slides To Show', 'volcano-addons' ),
		...
		$this->add_responsive_control(
			'slides_to_scroll',
			[
				'label'       => __( 'Slides to Scroll', 'volcano-addons' ),
				'description' => __( 'Set how many slides are scrolled per swipe.', 'volcano-addons' ),
				'type'        => Controls_Manager::NUMBER,
		...
		$this->add_control(
			'autoplay',
			[
				'label'   => __( 'Autoplay', 'volcano-addons' ),
				'type'    => Controls_Manager::SELECT,
				'default' => $options['autoplay'],
				'options' => [
					'yes' => __( 'Yes', 'volcano-addons' ),
					'no'  => __( 'No', 'volcano-addons' ),
				],
			]
		);
		...
		$this->add_control(
			'slides_center',
			[
				'label'   => __( 'Center Mode', 'volcano-addons' ),
				'type'    => Controls_Manager::SELECT,
				'default' => $options['slides_center'],
				'options' => [
					'true'  => __( 'Yes', 'volcano-addons' ),
					'false' => __( 'No', 'volcano-addons' ),
				],
			]
		);
		...
		$this->add_control(
			'autoplay_delay',
			[
				'label'     => __( 'Autoplay Speed (ms)', 'volcano-addons' ),
				'type'      => Controls_Manager::NUMBER,
		...
		$this->add_control(
			'spacing_between',
			[
				'label'   => __( 'Distance between slides in px', 'volcano-addons' ),
		...
		$this->add_control(
			'direction',
			[
				'label'   => __( 'Direction', 'volcano-addons' ),
				'type'    => Controls_Manager::SELECT,
				'default' => $options['direction'],
				'options' => [
					'ltr' => __( 'Left', 'volcano-addons' ),
					'rtl' => __( 'Right', 'volcano-addons' ),
				],
			]
		);
		...
		$this->add_control(
			'effect',
			[
				'label'       => __( 'Effect', 'volcano-addons' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => $options['effect'],
				'options'     => [
					'slide' => __( 'Slide', 'volcano-addons' ),
					'fade'  => __( 'Fade', 'volcano-addons' ),
				],
				'description' => __( 'Fade effect works when "Slides to Show" is 1', 'volcano-addons' ),
			]
		);
		...
		$this->add_control(
			'navigation',
			[
				'label'   => __( 'Navigation', 'volcano-addons' ),
				'type'    => Controls_Manager::SELECT,
				'default' => $options['navigation'],
				'options' => [
					'both'   => __( 'Arrows and Dots', 'volcano-addons' ),
					'arrows' => __( 'Arrows', 'volcano-addons' ),
					'dots'   => __( 'Dots', 'volcano-addons' ),
					'none'   => __( 'None', 'volcano-addons' ),
				],
			]
		);
		...
		$this->start_controls_section(
			'slider_navigation_position',
			array(
				'label'     => esc_html__( 'Navigation Style', 'volcano-addons' ),
		...
		$this->add_control(
			...
			[
				'label'            => __( 'Navigation Previous Icon', 'volcano-addons' ),
				'type'             => Controls_Manager::ICONS,
				'label_block'      => false,
				'fa4compatibility' => 'volcano-addons',
				'default'          => [
		...
		$this->add_control(
			...
			[
				'label'            => __( 'Navigation Next Icon', 'volcano-addons' ),
				'type'             => Controls_Manager::ICONS,
				'label_block'      => false,
				'fa4compatibility' => 'volcano-addons',
				'default'          => [
		...
		$this->add_control(
			'arrows_position',
			[
				'label'        => __( 'Arrows Position', 'volcano-addons' ),
				'type'         => Controls_Manager::SELECT,
				'default'      => $options['arrows_position'],
				'options'      => [
					'inside'  => __( 'Inside', 'volcano-addons' ),
					'outside' => __( 'Outside', 'volcano-addons' ),
				],
		...
		$this->add_control(
			...
			[
				'label'      => esc_html__( 'Left Arrow Position Vertically ', 'volcano-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'left_arrow_horizontally',
			[
				'label'      => esc_html__( 'Left Arrow Position Horizontally', 'volcano-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label'      => esc_html__( 'Right Arrow Position Vertically ', 'volcano-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'right_arrow_horizontally',
			[
				'label'      => esc_html__( 'Right Arrow Position Horizontally', 'volcano-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Normal', 'volcano-addons' ),
			]
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Navigation Background', 'volcano-addons' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Navigation Color', 'volcano-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Navigation Button Width', 'volcano-addons' ),
				'type'       => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Navigation Button Height', 'volcano-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'rem', 'em', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Navigation Box shadow', 'volcano-addons' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Navigation Border Color', 'volcano-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'      => esc_html__( 'Navigation button Border Radius', 'volcano-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Navigation Button Padding', 'volcano-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'rem', 'em', '%' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Navigation Button Margin', 'volcano-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'rem', 'em', '%' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Navigation Hover Color', 'volcano-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Navigation Hover Border Color', 'volcano-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'slider_dots_position',
			array(
				'label'     => esc_html__( 'Dots Style', 'volcano-addons' ),
		...
		$this->add_control(
			'dots_color',
			[
				'label'     => __( 'Dots Color', 'volcano-addons' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => esc_html__( 'Active Dot Border', 'volcano-addons' ),
		...
		$this->add_control(
			'dots_size',
			[
				'label'     => __( 'Dots Size', 'volcano-addons' ),
				'type'      => Controls_Manager::SLIDER,
		...
		$this->start_controls_tab(
			'dot_button_active',
			[
				'label' => esc_html__( 'Active', 'volcano-addons' ),
			]
		);
		...
		$this->add_control(
			'dots_active_color',
			[
				'label'     => __( 'Dots Active Color', 'volcano-addons' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'dot_gaps',
			[
				'label'      => esc_html__( 'Dots Gap', 'volcano-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'separator'  => 'before',
				'range'      => [
		...
		$this->add_control(
			'dot_horizontally',
			[
				'label'      => esc_html__( 'Dot Position Horizontally', 'volcano-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'dot_vertically',
			[
				'label'      => esc_html__( 'Dot Position Vertically ', 'volcano-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range'      => [
					'px' => [
		...
		if ( in_array( $settings['navigation'], [ 'arrows', 'both' ], true ) ) {
			...
			<div class="">
				<div
					...
					<span class="elementor-screen-only"><?php esc_html_e( 'Previous', 'volcano-addons' ); ?></span>
				</div>
				<div
					...
					<span class="elementor-screen-only"><?php esc_html_e( 'Next', 'volcano-addons' ); ?></span>
				</div>
			</div>
			<?php
		}
...
// End of file trait-volcano-addons-slider-controller.php.
